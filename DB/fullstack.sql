...
CREATE TABLE `posts_tags` (
  ...
  KEY `fk_posts_has_tags_posts1_idx` (`posts_id`),
  CONSTRAINT `fk_posts_has_tags_posts1` FOREIGN KEY (`posts_id`) REFERENCES `posts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2019-02-14 20:16:18
