	...
	<head>
		...
		*{ margin:0; padding:0;}
		...
		div.boxLogin{ padding:10px; background:#fff; margin-bottom:15px;}
			...
			div.boxLogin a{ color:rgb(45, 62, 80);}
			div.boxLogin h5{ display:block; text-align:center; color:rgb(45, 62, 80); font-size:18px; font-family:Arial, Helvetica, sans-serif; font-weight:normal;}
			div#login input#t{ border:1px solid #ccc; padding:5px; background:#FFF; width:94.5%;}
			div#login input[type="submit"]{ background:rgb(45, 62, 80); color:#FFF; padding:2px 5px; border:1px solid #999; cursor:pointer;}
			div.boxLogin2{ text-align:center;}
			div.boxLogin2 h5{ color:#fff; font-weight:normal; font-size:16px; display:block; background:rgb(45, 62, 80);}
